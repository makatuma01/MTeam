...
Feature: Pizza application place order functionality
  ...
  Scenario Outline: Validating successful place order
    ...
    Examples:
      ...
      | Small 10 Slices - 2 toppings | Mushrooms | Extra cheese | 3        | John Doe    | john@gmail.com  | 123456789 | Credit Card    |
      | Small 8 Slices - 2 toppings  | Olives    | Salami       | 2        | Kim Yan      | kim@gmail.com  | 123456789 | Cash on Pickup |
